...
alfam2pars03_alpha <- as.matrix(pars03_alpha)[, 1]
save(alfam2pars03_alpha, file = '../data/alfam2pars03_alpha.rda')

alfam2pars03var_alpha <- read.csv('pars_set3_var.csv', row.names = 1, header = TRUE)
alfam2pars03var_alpha <- as.matrix(alfam2pars03var_alpha)
save(alfam2pars03var_alpha, file = '../data/alfam2pars03var_alpha.rda')
