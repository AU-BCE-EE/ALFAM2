...
alfam2pars03 <- ALFAM2pars03 <- as.matrix(pars03)[, 1]
save(alfam2pars03, ALFAM2pars03, file = '../data/alfam2pars03.rda')

alfam2pars03var <- read.csv('pars_set3_var.csv', row.names = 1, header = TRUE)
alfam2pars03var <- ALFAM2pars03var <- as.matrix(alfam2pars03var)
save(alfam2pars03var, ALFAM2pars03var, file = '../data/alfam2pars03var.rda')
