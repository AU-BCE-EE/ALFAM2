...
This requires setting some inputs in a data frame that is then passed to the `uncert.settings` argument.
These settings can specify values for either uniform or normal distributions for uncertainty.
Furthermore, uncertainty can be relative (a fraction of the value given in `dat`) or adjusted to the center.
