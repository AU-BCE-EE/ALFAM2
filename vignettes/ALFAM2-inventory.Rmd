...
To separately look at the contributions of parameter and input variable uncertainty, or make any other quantitative comparison of uncertainty, the random number seed should be set for reproducibility with the `seed` argument.
