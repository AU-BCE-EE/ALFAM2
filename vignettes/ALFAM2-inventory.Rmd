...
If multiple aggregation combinations are needed, it may be best to make a single `alfami()` call and extract the results from the expanded uncertainty data frame for external aggregation.
