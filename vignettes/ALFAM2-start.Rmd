...
vignette: >
  %\VignetteIndexEntry{ALFAM2-start}
...
plot(wind.2m ~ ctime, data = dat7, type = 's', col = 'blue')
```
...
```{r, }
predci1 <- alfam2(dat7, pars = alfam2pars03, 
                  app.name = 'TAN.app', time.name = 'ctime', 
                  warn = FALSE, conf.int = 0.90, 
                  pars.ci = alfam2pars03var)
head(predci1)
```
...
```{r, }
predci2 <- alfam2(dat7, pars = alfam2pars03, 
                  app.name = 'TAN.app', time.name = 'ctime', 
                  warn = FALSE, conf.int = 0.90, 
                  pars.ci = alfam2pars03var, 
                  var.ci = c('er', 'j', 'r1'))
...
predci3 <- alfam2(dat12, pars = alfam2pars03, 
                  app.name = 'TAN.app', time.name = 'ctime', 
...
```{r, }
preduc1 <- alfam2(datuc1, pars = alfam2pars03, 
                  app.name = 'TAN.app', time.name = 'ctime', 
...
```{r, }
preduc2 <- alfam2(datuc2, pars = alfam2pars03, app.name = 'TAN.app', 
                  time.name = 'ctime', group = 'group',
                  conf.int = 0.9, pars.ci = alfam2pars03var)
print(preduc2)
```
