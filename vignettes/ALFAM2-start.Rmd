...
The model, which is described in Hafner et al. (2019)[^1] and Hafner et al. (2025)[^2], is the focus of the ALFAM2 R package and this document.
...
Development of this parameter set is described in Hafner et al. (2025)[^2].
...
[^2]: Hafner S, Pedersen J, Fuss R, Kamp J, Dalby F, Amon B, Pacholski A, Adamsen A, Sommer S., 2025. Improved tools for estimation of ammonia emission from field-applied animal slurry: refinement of the ALFAM2 model and database. *Atmospheric Environment*. <https://doi.org/10.1016/j.atmosenv.2024.120910>
